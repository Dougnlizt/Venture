...
AllowNoIcons=yes
OutputDir="C:\MyProjects\Venture\binary"
OutputBaseFilename=TJCS_LotteryInstallx64_5
...
Source: "C:\MyProjects\Venture\binary\Venture.jar"; DestDir: "{app}"; Flags: 64bit allowunsafefiles confirmoverwrite ignoreversion promptifolder replacesameversion
;Icon(s)
